...
#SBATCH --output=name%j_normMaxHist_cont.out
module purge
module load 2019
...
cd ..
srun python3 test_ac_dqn_2D.py --name=2Dcuriosity_LISA_normMaxHist --encoder_type="cont" --intr_rew_norm_type=max_history