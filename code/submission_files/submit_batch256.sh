...
#SBATCH --output=name%j_normNone_batch256.out
module purge
module load 2019
...
cd ..
srun python3 test_ac_dqn_2D.py --name=2Dcuriosity_LISA_normNone_batch256 --intr_rew_norm_type=none --batch_size=256