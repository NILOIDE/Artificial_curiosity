...
cd ..
srun python3 test_ac_dqn_2D.py --name=2Dcuriosity_LISA_vaeEncNoDetach --z_dim='(512,)' --wm_h_dim='(256,)' --encoder_type='vae' --wm_opt='adam' --wm_lr=1e-4 --seed=1 --train_steps=10000000