...
#SBATCH --output=name%j_normNone_random_lr00001.out
module purge
module load 2019
...
cd ..
srun python3 test_ac_dqn_2D.py --name=2Dcuriosity_LISA_normNone_lr00001 --intr_rew_norm_type=none --alg_lr=0.0001 --wm_lr=0.0001