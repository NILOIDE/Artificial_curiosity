...
cd ..
srun python3 test_ac_dqn_2D.py --name=2Dcuriosity_LISA --z_dim='(512,)' --wm_h_dim='(256,)' --neg_samples=10 --hinge_value=0.1 --encoder_type='cont' --wm_opt='adam' --wm_lr=1e-4 --wm_enc_lr=1e-3 --seed=1 --train_steps=10000000